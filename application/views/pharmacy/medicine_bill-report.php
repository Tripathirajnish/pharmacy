            ...
            <div class="history">
                ...
                <table style="border-collapse: collapse;font-size: 14px;width: 100%">
					...
					<tr style="border-collapse: collapse;">
                            <th style="padding: 5px;text-align: left;">Bill No :</th>
                            <td style="text-align: left;"><?=isset($bill)?$bill:'-'?></td>
                            <th style="text-align: left;">Date:</th>
                            <td  style="text-align: left;"><?=isset($tdate)?$tdate:'-'?></td>
                        </tr>
                        <tr style="border-collapse: collapse;">
						 <?php
                          //print_r($patient);
						 $pt=$this->db->get_where('patient', ['uhid' => $patient])->row(); ?>
                            <th style="padding: 5px;text-align: left;">Name :</th>
                            <td style="text-align: left;"><?=isset($pt)?$pt->first_name. ' '.$pt->middle_name.' '.$pt->last_name:'-'?></td>
                            <th style="text-align: left;">Doctor:</th>
                            <td  style="text-align: left;"><?=isset($doctor)?$doctor:'-'?></td>
                        </tr>
