...
<section class="content">
    ...
    <div class="row">
      <h6 class="btn btn-primary float-right"><a href="<?= base_url('superadmin/pharmacyController/nearExpirymedicine'); ?>" style="color:#fff"><span style="font-size:15px;"></span>Near Expiry Medicine</a></h6>   
