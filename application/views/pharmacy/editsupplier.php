  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <center><h1 class="m-0 text-dark">Edit Supplier</h1></center>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<form action="<?= base_url('pharmacyController/updategategory'); ?>" enctype="multipart/form-data" method="post">
        <div class="row">
		<div class="col-md-4">
          <label>Supplier Name</label>
          <input type="text" value="<?=$supplier->name; ?>" id="supplier" name="name" class="form-control" placeholder="Supplier Name " >
        ...
        <div class="col-md-4">
          ...
          <input type="text" value="<?=$supplier->contact_no; ?>" name="contact_no" class="form-control" >
