  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <center><h1 class="m-0 text-dark">Repurchase Medicine Details</h1></center>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Repurchase Medicine Details</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <center><h3>Repurchase Medicine Details</h3></center>
	  ...
	  <br><br>
          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
			  ...
			  $product = $this->db->get_where('product_manage', ['id' => $products->product_id])->row();
