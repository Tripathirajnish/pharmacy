      ...
      <section class="content">
       ...
       <div class="card" style="padding: 12px;">
        <div class="card-header">
          <strong>Pharmacy Sale Report Export</strong>
        </div>
        <div class="card-body card-block">
          <form action="<?= base_url('superadmin/pharmacyReportController/ExportSale'); ?>" method="post" name="f2">
            <div id="dynamicInput">
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-10">
                  ...
                  <input  id="ReportType" name="ReportType" type="radio" value="Daily"> Daily
              ...
              <!-- <div class="box-body col-md-6 col-sm-12 bArea"> -->
                <div class="form-group col-sm-12" id="ydata">
                  ...
                  <div class="col-sm-4">
                    <select name="year"  class="form-control" required="">
                      ...
                      <option value="2017"  selected="">2017</option><option value="2018" if(09-10-2020="=2018)" selected="">2018</option><option value="2019" selected="">2019</option>
                ...
                <div class="col-md-2"><br>
                 <div class="col-md-6">
                  <!-- <button type="submit" class="btn btn-primary btn-sm" name="submit" onclick="f2.action='pharmacyReportController/ExportSale';return true;">
                    <i class="fa fa-dot-circle-o"></i>View
                  </button> -->
                </div>
                <div class="col-md-6">
                  <button type="submit" class="btn btn-primary btn-sm" name="submit" onclick="this.form.target='pharmacyReportController/ExportSale';return true;">
