  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <center><h1 class="m-0 text-dark">Purchase Request</h1></center>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<section class="content">
  <h3 class="text-center">Purchase Request</h3>
     <!--    <?php //echo form_open('doctorController/addDoctor');?> -->
		...
		<form action="<?= base_url('superadmin/RequestController/Addrequest'); ?>" enctype="multipart/form-data" method="post">
		           <div class="row">
				   <div class="col-md-4">
    ...
    $(document).ready(function() {
		...
		$("[data-toggle=tooltip]").tooltip();
		 $("#searchInput").keyup(function(){
			...
			if(med != ''){
			 $.ajax({
			url:"<?=base_url('superadmin/pharmacyController/SearchSaleMedicine')?>",
			type:'POST',
			data: {med: med},
