  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <center><h1 class="m-0 text-dark">Request Product</h1></center>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <center><h3>Request Product</h3></center>
      ...
      <?php   } ?>
	  <button class="btn btn-primary"><a href="<?= base_url('RequestController'); ?>" style="color:#fff">Product Request</a></button><br>
