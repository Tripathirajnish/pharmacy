...
<form action="<?= base_url('superadmin/SendsmsController/sendSms'); ?>" enctype="multipart/form-data" method="post">
        <div class="row">
		<div class="col-md-4">
          <label>Mobile NO</label>
          <input type="text" value="" id="supplier" name="mobile" class="form-control" placeholder="Supplier Name " >
        </div>
        <div class="col-md-4">
          <label>Message</label>
	...
	<!-- <button><a href="<?= base_url('SendsmsController/sendSms'); ?>">Sendsms</a></button> -->
