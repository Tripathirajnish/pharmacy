  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <center><h1 class="m-0 text-dark">Medicine Details</h1></center>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <a href="<?= base_url('pharmacyController'); ?>"><button class="btn btn-primary add-doctor">Add 
        Medicine</button></a>
      ...
      <?php   } ?>
	  <br><br>
  <form action="<?= base_url('pharmacyController/productList'); ?>" enctype="multipart/form-data" method="post">
